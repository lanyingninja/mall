...
<table width="500" cellspacing="4" cellpadding="1">
  ...
  <tr>
    ...
    <td style="font-size:13px; color:#F00">包邮！</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr style="text-align:center;">
    ...
    <td style="font-size:13px; color:#333">暂无优惠</td>
  </tr>
  <tr id="haha">
    <td height="51" style="font-size:13px; color:#333">款式</td>
    <td colspan="2"> 
    <input type="radio" name="color" value="大" checked="checked"/>大
    <input type="radio" name="color" value="中"/>中
    <input type="radio" name="color" value="小"/>小
...
<div id="cuxiao">
<span style="color:#333; font-size:13px; text-align:center; font-weight:bold">其他商品</span><br />
